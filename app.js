...
class App{
  ...
  ready(){
    ...
    //QVGA 1280x960
    //XVGA 1024x768
    this.mainWindow = new electron.BrowserWindow({width:1024,height:768,center: true,"always-on-top": true, kiosk: true, frame:false, fullscreen: true,useContentSize: true});
